  ...
  return (
    ...
    >
      <div ref={contentRef} className="text-center">
        <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center shadow-lg">
        ...
        <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-md mx-auto mb-8">
          Learn about our mission, values, and the story behind our brand.
        </p>
