...
// Poppins drives body/UI text on the home page (per design). Titles and big
...
// The site's main home page (/). Content is fetched from Shopify (metaobjects +
// live products + blog articles) at build time, then rendered through the
// optimist-website-styled sections. Sections fall back to the reference's static
// copy when a metaobject is absent.
